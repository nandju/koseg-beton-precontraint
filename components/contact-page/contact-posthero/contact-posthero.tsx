      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <BlurFade delay={0.1} direction="left" inView={true}>
              <div>
            ...
            <div className="space-y-8">
              ...
              <BlurFade delay={0.3} direction="left" inView={true}>
                <div>
                  <h3 className="text-lg font-semibold mb-3" style={{ color: '#0B2C72' }}>
                    Votre Message
                  </h3>
          ...
          <BlurFade delay={0.2} direction="right" inView={true} duration={0.8}>
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <BlurFade delay={0.3} direction="up" duration={0.5}>
              ...
              //  onSubmit={handleSubmit} 
               className="space-y-6">
                ...
                <BlurFade delay={0.4} direction="up" duration={0.5}>
                ...
                <BlurFade delay={0.5} direction="up" duration={0.5}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <input
                        type="tel"
                ...
                {/* Message */}
                <BlurFade delay={0.6} direction="up" duration={0.5}>
                  <div>
                    <textarea
                      name="message"
                ...
                {/* Checkbox */}
                <BlurFade delay={0.7} direction="up" duration={0.5}>
                ...
                {/* Bouton Submit */}
                <BlurFade delay={0.8} direction="up" duration={0.5}>
                  <div>
                    <button
                      type="submit"
