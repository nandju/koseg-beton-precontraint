  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/images/illustrations/page-Blogs/hero.png')",
        }}
      >
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
        {/* Main Title */}
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold mb-8 text-balance">Blogs</h1>
