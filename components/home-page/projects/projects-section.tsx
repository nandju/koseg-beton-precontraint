...
export default function ProjectsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative min-h-screen bg-[#0B2C72] overflow-hidden transition-all duration-1000 ${
        isVisible ? "scale-100 opacity-100" : "scale-95 opacity-90"
      }`}
    >
      {/* Background expansion effect */}
      <div
        className={`absolute inset-0 bg-gradient-to-br from-[#0B2C72] to-[#374151] transition-transform duration-1000 ${
