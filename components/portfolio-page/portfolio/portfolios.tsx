...
const projects = [
  {
    ...
    description: 'Planchers précontraints et solutions de post-tension pour bâtiment commercial, optimisant portées, sécurité et durabilité.',
  },
  {
    id: 2,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project) => (
              <div
                ...
                // className="group relative overflow-hidden rounded-2xl shadow-lg transition-all duration-500 hover:shadow-2xl cursor-pointer"
